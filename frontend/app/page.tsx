              ...
              {displayCards.map((event) => (
                ...
                >
                  <div className="aspect-[14/10] w-full overflow-hidden bg-slate-50 relative">
                    <img 
    // LAYER 1: Use dynamic database string, fallback if empty string or missing completely
    src={event.imageUrl && event.imageUrl.trim() !== "" 
      ? event.imageUrl 
      : "https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?q=80&w=600"
    } 
    alt={event.title} 
    className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-101" 
    // LAYER 2: Safety shield if the link returns a 404 error at runtime
    onError={(e) => {
      (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?q=80&w=600";
    }}
  />
